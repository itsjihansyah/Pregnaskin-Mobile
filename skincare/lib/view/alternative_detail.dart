...
class _AlternativeDetailState extends State<AlternativeDetail> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Detail", style: AppTextStyle.withWeight(AppTextStyle.h3, FontWeight.w600)),
        actions: [
          IconButton(
            onPressed: () {},
            ...
            child: Column(
              ...
              children: [
                ...
                Chip(
                  ...
                  backgroundColor: widget.alternativeProduct.safe.toLowerCase() == 'safe' ? Colors.black : Color(0xFF979AAC),
                ...
                Text(
                  ...
                  style: AppTextStyle.withColor(AppTextStyle.bodyLarge, Color(0xFF979AAC)),
                  maxLines: 1,
                ),
                SizedBox(height: size.height * 0.001),
                ...
                child: TabBarView(
                  ...
                  children: [
                    ...
                    Column(
                      children: [
                        ...
                        SingleChildScrollView(
                          ...
                          child: Row(
                            children: [
                              _buildFeatureContainer(Mdi.earth, widget.alternativeProduct.country, "Product"),
                              SizedBox(width: 12),
                    ...
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("Benefits", style: AppTextStyle.withWeight(AppTextStyle.bodyMedium, FontWeight.bold)),
                        SizedBox(height: 8),
                        FeatureChips(features: widget.alternativeProduct.feature),
                      ],
                    ),
                    // Ingredients Tab
                    Padding(
